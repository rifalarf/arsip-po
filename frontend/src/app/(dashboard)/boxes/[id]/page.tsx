        ...
        <div className="hidden print:block print:p-8">
          <div className="border-2 border-black p-6 space-y-4">
            <div className="text-center">
              <h2 className="text-2xl font-bold">{box.no_gungyu}</h2>
              <p className="text-sm font-mono">{box.location_code}</p>
              <p className="text-sm">Tahun {box.tahun}</p>
            </div>
            <Separator />
            <div>
              <p className="font-semibold mb-2">Daftar PO:</p>
              <div className="grid grid-cols-3 gap-1 text-xs font-mono">
                {pos.map((po) => (
                  <span key={po.id}>{po.no_po}</span>
                ))}
              </div>
            </div>
          </div>
